...
# workaround below to use a different sound driver
...
class AlienInvasion:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # A collisions dictionary only exists if a bullet
        # hit an alien
        if collisions:
            # check for each key for multiple hits
    ...
    def _update_aliens(self):
        ...
        the positions of all the aliens in the fleet.
        """
